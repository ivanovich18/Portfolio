        ...
        <section id='projects' className='projects'>
            ...
            <div className='projectShowcase'>
                <a className='transform' href='https://github.com/ivanovich18/Quiz-tion-AI' target='_blank'>
                    <section className='projectPic' data-aos="zoom-in" data-aos-duration="600" data-aos-delay="500">
                        <h3>Quiz-tion AI</h3>
                ...
                <a href='https://github.com/ivanovich18/Student-Enrollment-Application' target='_blank'>
                    <section className='projectPic' data-aos="zoom-in" data-aos-duration="600" data-aos-delay="700">
                ...
                <a href='https://github.com/ivanovich18/little-lemon-ivan-suralta' target='_blank'>
                    <section className='projectPic' data-aos="zoom-in" data-aos-duration="600" data-aos-delay="900">
                ...
                <a href='https://github.com/ivanovich18/Mangata-and-Gallo-Landing-Page' target='_blank'>
                    <section className='projectPic' data-aos="zoom-in" data-aos-duration="600" data-aos-delay="1100">
