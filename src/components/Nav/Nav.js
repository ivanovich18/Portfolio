    ...
    return (
        ...
        <nav className="navBar">
            ...
            <div className='navMenu' style={{ display: showMenu ? 'flex' : 'none' }}>
                ...
                <Link activeClass='active' to='about' spy={true} smooth={true} offset={-50} duration={500} className='mobileItem' onClick={() => setShowMenu(false)}>About</Link>
                ...
                <Link activeClass='active' to='contact' spy={true} smooth={true} offset={-20} duration={500} className='mobileItem' onClick={() => setShowMenu(false)}>Contact Me</Link>
            </div>
        </nav >
        </div>
    );
